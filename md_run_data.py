...
class MDRunData:
   ...
   def rundata_init(self, thermo_keywords):
      ...
      # creates a pandas DataFrame to store the thermo data
      # and initializes the DataFrame columns with thermo keywords
   ...
   def rundata_update(self, data_per_step):
      ...
      # Filling the DataFrame thermo_output with thermo data
   ...
   def append(self, list_md_rundata):
      ...
      # Recursive function to append data from a series of MDRunData
      # instances to the current MDRunData instance
      ...
      if len(list_md_rundata) == 0: # Condition for exiting the recursive function
         return
      ...
      ### Metadata update: ###
      # If unique, then that unique value is stored
      # Else a list of values is stored obtained from all
      # the appending MDRunData instances   
      ...
      # Appending the thermo_output DataFrame with new data from appending 
      # MDRunData instances   
